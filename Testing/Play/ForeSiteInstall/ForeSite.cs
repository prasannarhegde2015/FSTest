    ...
    public class ForeSite
    {
        ...
        public void ForeSiteScreen(string Server, string database)
        {
            ...
            try
            {
                ...
                Playback.Wait(sleeptime);
                Mouse.Click(PageObjects.testconnectionOK);
                for (int i = 0; i < 4; i++)
                {
                    Mouse.Click(PageObjects.next);
                    Playback.Wait(sleeptime);
        ...
        public void ForeSiteScreenUpgrade(string Server, string database)
        {
            ...
            try
            {
                ...
                Trace.WriteLine("Clcicked Next");
                Playback.Wait(sleeptime);
                Assert.AreEqual(true, PageObjects.foresiteclient.Checked,"ForeSite Client was not Checked");
                Assert.AreEqual(true, PageObjects.Foresiteserver.Checked, "ForeSite Server was not Checked");
                Assert.AreEqual(true, PageObjects.wellmodeling.Checked, " WellFlo was not Checked");
                Assert.AreEqual(true, PageObjects.dynacard.Checked, "Dynacard was not Checked");
                Assert.AreEqual(true, PageObjects.reocomm.Checked, "Reo COMM was not Checked");
                Assert.AreEqual(true, PageObjects.reoserivce.Checked, "ReoService was not Checked");
                Assert.AreEqual(true, PageObjects.catalogservice.Checked, "Catalog was not Checked");
                Mouse.Click(PageObjects.next);
                Playback.Wait(sleeptime);
                Mouse.Click(PageObjects.next);
                Playback.Wait(sleeptime);
                Assert.AreEqual(sqlservername, PageObjects.sqlserver.Text, "SQL Server Name was not present");
                Assert.AreEqual(dbname,PageObjects.dbname.Text,"Db name was prenset");
                Mouse.Click(PageObjects.testconnection);
                Playback.Wait(sleeptime);
                Mouse.Click(PageObjects.testconnectionOK);
                for (int i = 0; i < 4; i++)
                ...
                Assert.AreEqual(licserver, PageObjects.licserver.Text, "License Server was not checked");
                Mouse.Click(PageObjects.next);
                Playback.Wait(sleeptime);
                Assert.AreEqual(domain, PageObjects.domain.Text, "CygNet Domain was not present");
                Assert.AreEqual(sitename, PageObjects.site.Text, "CygNet Site was not present");
                Assert.AreEqual(vhssite, PageObjects.vhs.Text, "CygNet VHS was present");
                Mouse.Click(PageObjects.next);
                Playback.Wait(sleeptime);
                Mouse.Click(PageObjects.next);
                Playback.Wait(sleeptime);
        ...
        public void ForeSiteScreenUIA(string Server, string database)
        {
            ...
            //    int sleeptime = 3000;
                Trace.WriteLine("Looking for check box I agreee");
                Trace.WriteLine($"SQL server name:{sqlservername}");
                UAActions.waitClick(UAPageObjects.iagree);
