...
namespace ForeSiteIsntall
{
    class UAPageObjects
    {
        ...
        public static AutomationElement iagree
        {
            get
            {
                AutomationElement iagree = CheckBox("I agree to the License Terms and Conditions.");
                return iagree;
            }
        }
        ...
        public static WpfEdit sqlserver
        {
            get
            {
                ...
                next.SearchProperties[WpfEdit.PropertyNames.Name] = "Server name:";
                return sqlserver;
            }
        }
        ...
        public static WpfEdit dbname
        {
            get
            {
                ...
                next.SearchProperties[WpfEdit.PropertyNames.ControlType] = "Edit";
                next.SearchProperties[WpfEdit.PropertyNames.Name] = "Enter a database:";
                return dbname;
            }
        }
        ...
        public static AutomationElement Window(string title)
        {
            Trace.WriteLine(AutomationElement.RootElement.Current.ProcessId.ToString());
            AutomationElement root = AutomationElement.RootElement;
            AutomationElement bundlwwin = null;
            do
            {
                ...
                {
                    Trace.WriteLine(indelm.Current.Name);
                    if (indelm.Current.Name.Equals(title))
                    {
                        bundlwwin = indelm;
                        break;
                    }
        ...
        public static AutomationElement CheckBox(string title)
        {
            AutomationElement uichekbox = null;
            do
            {
                AutomationElementCollection allwins = Window("Weatherford ForeSite Bundle").FindAll(TreeScope.Descendants,
                     new System.Windows.Automation.PropertyCondition(AutomationElement.ControlTypeProperty, System.Windows.Automation.ControlType.CheckBox));
